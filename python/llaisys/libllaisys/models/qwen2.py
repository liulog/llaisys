from ctypes import c_void_p, c_int, c_int64, c_size_t
...
def load_qwen2(lib):
    ...
    lib.llaisysQwen2ModelInfer.argtypes = [ctypes.POINTER(LlaisysQwen2Model), ctypes.POINTER(c_int64), c_size_t]
